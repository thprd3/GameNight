...
// Objects (games) - import/export better?
const games = [];
...
let keep_talking = new Game("Keep Talking And Nobody Explodes");
games.push(keep_talking);
let love_letter = new Game("Love Letter");games.push(love_letter);
let motorcycle = new Game("Motorcycle Mechanic Simulator 2021");
games.push(motorcycle);
